...
import { useInventorySurpluses } from '@/features/manage-inventory-surpluses/model/useInventorySurpluses'
...
export function InventorySurplusTable() {
    ...
    const { data, isLoading } = useInventorySurpluses({ 
    ...
    const handleDelete = (id: string) => {
        confirmDialog.showConfirm(
            t('inventorySurpluses.deleteConfirm'),

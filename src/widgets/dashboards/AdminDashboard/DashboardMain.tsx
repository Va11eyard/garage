...
import { BookOpen, Users, Package, Wrench, FileText, Network, Building2, Warehouse, Box, Building } from 'lucide-react'
...
export function DashboardMain() {
    ...
    const modules = [
        ...
        { tKey: 'integration', href: '/integration', icon: Network, color: 'text-cyan-500', bgColor: 'bg-cyan-50' },
    ]
